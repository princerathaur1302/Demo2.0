...
photologo = 'https://i.postimg.cc/2S3DWfC2/images.png' #https://envs.sh/GV0.jpg
photoyt = 'https://i.postimg.cc/2S3DWfC2/images.png' #https://envs.sh/GVi.jpg
photocp = 'https://i.postimg.cc/2S3DWfC2/images.png'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="http://t.me/contact_262524_bot"),
            InlineKeyboardButton(text="🛠️ Help", url="http://t.me/contact_262524_bot"),
        ],
    ]
)
...
image_urls = [
    "https://i.postimg.cc/2S3DWfC2/images.png",
    "https://i.postimg.cc/2S3DWfC2/images.png",
...
async def txt_handler(bot: Client, m: Message):  
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                cc = f'[🎥]Vid Id : {str(count).zfill(3)}\n**Video Title :** {name1} [{res}p].mkv\n<pre><code>**Batch Name :** {b_name}</code></pre>\n\n**Extracted by➤**{CR} https://t.me/addlist/C4FsGVXQeGRkZjM1 \n'
